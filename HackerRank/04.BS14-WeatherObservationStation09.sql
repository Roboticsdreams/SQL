...
CREATE or ALTER PROCEDURE basicselect.proc_14wos09 AS
select 
	distinct(city)
from 
	basicselect.STATION
...
CREATE or ALTER PROCEDURE BasicSelectTestClass.test_14wos09 AS
BEGIN
    ...
    INSERT INTO actual (CITY) exec basicselect.proc_14wos09
...
--exec tSQLt.Run 'BasicSelectTestClass.[test_14wos09]';