...
- Download and Install [MS SQL Server](https://www.microsoft.com/en-in/sql-server/sql-server-downloads?rtc=1).
...
| 4 | [Select By ID](https://www.hackerrank.com/challenges/select-by-id/problem) | [SQL](HackerRank/04.BS04-SelectByID)
